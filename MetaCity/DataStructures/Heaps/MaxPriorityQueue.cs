...
namespace MetaCity.DataStructures.Heaps
{
    ...
    public class MaxPriorityQueue<TKey, TPriority> where TKey : IComparable<TKey> where TPriority : IComparable<TPriority>
    {
        ...
        /// <summary>
        /// Instance property.
        /// The internal BinaryMaxHeap storing PriorityQueueNodes with key, priority.
        /// </summary>
        public BinaryMaxHeap<PriorityQueueNode<TKey, TPriority>> QueueHeap { get; }
        ...
        /// </summary>
        public MaxPriorityQueue() : this(0, null) { }
        /// <summary>
        /// Constructor of MaxPriorityQueue with initial capacity.
        /// </summary>
        /// <param name="capacity"></param>
        public MaxPriorityQueue(int capacity) : this(capacity, null) { }
        /// <summary>
        /// Constructor of MaxPriorityQueue with initial capacity and comparer.
        /// </summary>
        /// <param name="capacity"></param>
        /// <param name="priorityComparer"></param>
        public MaxPriorityQueue(int capacity, Comparer<PriorityQueueNode<TKey, TPriority>> priorityComparer)
        {
            if (capacity < 0)
            {
            ...
            QueueHeap = new BinaryMaxHeap<PriorityQueueNode<TKey, TPriority>>(capacity, _priorityComparer);
        }
        ...
        /// <summary>
        /// Returns the highest priority element's priority.
        /// </summary>
        /// <returns></returns>
        public TPriority PeekPriorityAtMax()
        {
            if (QueueHeap.IsEmpty)
            {
                throw new ArgumentOutOfRangeException("Queue is empty.");
            }
            return QueueHeap.Peek().Priority;
        }
        ...
        public TKey DequeueMax()
        {
            ...
            var key = QueueHeap.ExtractMax().Key;
