...
{
    internal readonly struct ParsedCoordinates
    {
        ...
        private ParsedCoordinates(object obj)
            => _obj = obj;

        public static ParsedCoordinates Parse(ref Utf8JsonReader reader, GeometryFactory factory)
        {
            ...
            {
                return new ParsedCoordinates(ParsePoint(ref reader, factory));
            }
            ...
            if (reader.TokenType == JsonTokenType.Number)
            {
                return new ParsedCoordinates(ParseCoordinateSequence(ref reader, factory));
            }
            ...
            if (reader.TokenType == JsonTokenType.Number)
            {
                return new ParsedCoordinates(ParseCoordinateSequenceList(ref reader, factory).ToArray());
            }
            ...
            return new ParsedCoordinates(ParseMultiPolygon(ref reader, factory));
        }
