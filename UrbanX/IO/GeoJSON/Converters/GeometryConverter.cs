...
namespace UrbanX.IO.GeoJSON.Converters
{
    internal partial class GeometryConverter : JsonConverter<Geometry>
    {
        ...
        */
        ...
        public GeometryConverter(GeometryFactory geometryFactory, bool writeGeometryBBox)
        {
        ...
        public override Geometry Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            ParsedCoordinates coordinateData = default;
            ...
            while (reader.TokenType == JsonTokenType.PropertyName)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "geometries":
                        ...
                        break;
                    case "coordinates":
                        coordinateData = ParsedCoordinates.Parse(ref reader, _geometryFactory);
                        reader.Read();
                        break;
                    case "bbox":
