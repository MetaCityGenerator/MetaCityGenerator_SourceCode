...
namespace UrbanX.IO.GeoJSON.Converters
{
    ...
    /// </summary>
    internal sealed class FeatureConverter : JsonConverter<IFeature>
    {
        ...
        public override void Write(Utf8JsonWriter writer, IFeature value, JsonSerializerOptions options)
        {
            ...
            GeometryConverter.WriteBBox(writer, bbox, options, value.Geometry);
        ...
        public override IFeature Read(ref Utf8JsonReader reader, Type objectType, JsonSerializerOptions options)
        {
            ...
            while (reader.TokenType == JsonTokenType.PropertyName)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "bbox":
                        var bbox = GeometryConverter.ReadBBox(ref reader, options);
