namespace UrbanX.DataStructures.Geometry
{
    public class VRBTreeNode<T>
    {
        ...
        public VRBTreeNode<T> Left { get; internal set; }
        public VRBTreeNode<T> Right { get; internal set; }
        public VRBTreeNode<T> Parent { get; internal set; }

        //cached ordered traversal
        public VRBTreeNode<T> Previous { get; internal set; }
        public VRBTreeNode<T> Next { get; internal set; }

        internal bool Red { get; set; }

        internal VRBTreeNode(T data)
        {
            Data = data;
        }
    }

    public class VRBTree<T>
    {
        public VRBTreeNode<T> Root { get; private set; }

        public VRBTreeNode<T> InsertSuccessor(VRBTreeNode<T> node, T successorData)
        {
            var successor = new VRBTreeNode<T>(successorData);

            VRBTreeNode<T> parent;
        ...
        public void RemoveNode(VRBTreeNode<T> node)
        {
        ...
        public VRBTreeNode<T> GetFirst(VRBTreeNode<T> node)
        {
            if (node == null)
                return null;
        ...
        public VRBTreeNode<T> GetLast(VRBTreeNode<T> node)
        {
            if (node == null)
                return null;
        ...
        private void RotateLeft(VRBTreeNode<T> node)
        {
            var p = node;
            var q = node.Right;
            var parent = p.Parent;
        ...
        private void RotateRight(VRBTreeNode<T> node)
        {
            var p = node;
            var q = node.Left;
            var parent = p.Parent;
