...
namespace UrbanX.DataStructures.Geometry
{
    internal class BeachSection
    {
        ...
        // Note: this property will change
    ...
    {
        private readonly VRBTree<BeachSection> _beachLine;

        internal BeachLine()
        {
            _beachLine = new VRBTree<BeachSection>();
        }

        internal void AddBeachSection(FortuneSiteEvent siteEvent, BinaryMinHeap<IFortuneEvent> eventQueue, HashSet<FortuneCircleEvent> deleted, LinkedList<VEdge> edges)
        {
            var site = siteEvent.Site;
            var x = site.X;
            var directrix = site.Y;

            VRBTreeNode<BeachSection> leftSection = null;
            VRBTreeNode<BeachSection> rightSection = null;
            ...
            //in the tree
            var newSection = _beachLine.InsertSuccessor(leftSection, section);
            ...
            if (leftSection != null && leftSection == rightSection)
            {
                ...
                var y = Parabola.EvalParabola(leftSection.Data.Site.X, leftSection.Data.Site.Y, directrix, x);
        ...
        internal void RemoveBeachSection(FortuneCircleEvent circle, BinaryMinHeap<IFortuneEvent> eventQueue, HashSet<FortuneCircleEvent> deleted, LinkedList<VEdge> edges)
        {
            ...
            var toBeRemoved = new List<VRBTreeNode<BeachSection>>();
        ...
        private double LeftBreakpoint(VRBTreeNode<BeachSection> node, double directrix)
        {
            ...
            return Parabola.IntersectParabolaX(leftSite.X, leftSite.Y, site.X, site.Y, directrix);
        }

        private double RightBreakpoint(VRBTreeNode<BeachSection> node, double directrix)
        {
            ...
            return Parabola.IntersectParabolaX(site.X, site.Y, rightSite.X, rightSite.Y, directrix);
        }

        private void CheckCircle(VRBTreeNode<BeachSection> section, BinaryMinHeap<IFortuneEvent> eventQueue)
        {
            //if (section == null)
            //    return;
