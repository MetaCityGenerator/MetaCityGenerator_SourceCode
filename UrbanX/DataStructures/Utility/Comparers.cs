...
namespace UrbanX.DataStructures.Utility
{
    public static class Comparers
    {
        ...
        /// <summary>
        /// Using Object equality comparer. 
        /// Need to define and override the Equals for T.
        /// </summary>
        ...
        private static bool HandleNullCases<T>(RBTreeNode<T> first, RBTreeNode<T> second) where T : IComparable<T>
        {
        ...
        public static bool IsEqualTo<T>(this RBTreeNode<T> first, RBTreeNode<T> second) where T : IComparable<T>
        {
            return (HandleNullCases(first, second) && first.Value.CompareTo(second.Value) == 0);
        }

        public static bool IsGreaterThan<T>(this RBTreeNode<T> first, RBTreeNode<T> second) where T : IComparable<T>
        {
            return (HandleNullCases(first, second) && first.Value.CompareTo(second.Value) > 0);
        }

        public static bool IsLessThan<T>(this RBTreeNode<T> first, RBTreeNode<T> second) where T : IComparable<T>
        {
            return (HandleNullCases(first, second) && first.Value.CompareTo(second.Value) < 0);
        }

        public static bool IsLessThanOrEqualTo<T>(this RBTreeNode<T> first, RBTreeNode<T> second) where T : IComparable<T>
        {
            return (first.IsEqualTo(second) || first.IsLessThan(second));
        }

        public static bool IsGreaterThanOrEqualTo<T>(this RBTreeNode<T> first, RBTreeNode<T> second) where T : IComparable<T>
        {
