...
{
    public class VisibilityAnalysisDecay_ExposureRate3DMesh : GH_Component
    {
        /// <summary>
        ...
        public VisibilityAnalysisDecay_ExposureRate3DMesh() : base("", "", "", "", "")
        {
            //ToDo 完善这部分内容
            ...
            this.Name = "VisibilityAnalysisDecay_ExposureRate3DMesh";
            this.NickName = "Decay_ExposureMesh";
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            //开始相切
            MeshCreation.CalcRaysThroughTriParallelDecay(wholeMesh, ptLargeList.ToArray(), viewRangeRadius, beta,
        ...
        {
            get { return new Guid("C891928A-1B4D-4DB8-A0F5-CADD58A413EF"); }
        }
    }
}
