...
{
    public class NetworkStructure_Computing3D : GH_Component
    {
        ...
        public NetworkStructure_Computing3D() : base("", "", "", "", "")
        {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (!DA.GetDataList(0, curves) || !DA.GetData(1, ref radius) || !DA.GetData(2,ref merge))
                return;
            ...
            graph.Build();
            var computing = new SpaceSyntaxComputing3D(graph.Graph, radius);
        ...
        {
            get { return new Guid("5D5268F0-95D2-46A2-9100-4115DF7C0D4C"); }
        }
    }
