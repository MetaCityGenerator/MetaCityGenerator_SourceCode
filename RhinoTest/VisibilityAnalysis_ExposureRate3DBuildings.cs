...
{
    public class VisibilityAnalysis_ExposureRate3DBuildings : GH_Component
    {
        /// <summary>
        ...
        public VisibilityAnalysis_ExposureRate3DBuildings() : base("", "", "", "", "")
        {
            //ToDo 完善这部分内容
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            {
                //开始相切
                MeshCreation.CalcRaysThroughTriParallel(sidesMesh, ptLargeList.ToArray(), viewRangeRadius, 0, secPtDic,
            ...
            else
            {
                ...
                //开始相切
                MeshCreation.CalcRaysThroughTriParallel(sidesMesh, selectedMeshIndices.ToArray(), spatial, ptLargeList.ToArray(), viewRangeRadius, secPtDic,
                    out meshIntrDic, out TotalVisArea, out  VisRatio, out NormalizedVisArea);
        ...
        {
            get { return new Guid("722F5A09-2451-44E6-826F-8DE52A9BC570"); }
        }
    }
